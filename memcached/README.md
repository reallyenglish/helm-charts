...
Picked from [stable/memcached](https://github.com/kubernetes/charts/tree/master/stable/memcached).

## TL;DR;

```bash
$ helm repo add reallyenglish https://storage.googleapis.com/re-charts
$ helm install reallyenglish/memcached
```
...
```bash
$ helm install --name my-release reallyenglish/memcached
```
...
```bash
$ helm install --name my-release -f values.yaml reallyenglish/memcached
```
